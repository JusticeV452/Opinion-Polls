...
def run_tableau_flow(tableau_prep_cli_path, flow_file_path):
...
def process_state_data(file_location, output_file):
...
def main():
    ...
    flow_file_path = 'tableau/tableu_prep_flows/Clean_State_Data.tfl'
    
    # Run the Tableau Flow
    run_tableau_flow(tableau_prep_cli_path, flow_file_path)

    # Process the state data
    file_location = 'data/Combined States Data.csv'
    output_file = 'data/leading_party_by_state.csv'
    process_state_data(file_location, output_file)
